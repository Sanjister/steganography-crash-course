...
Our "key" will be an image in which a message will be concealed by slightly altering the base pixel values. These changes should be unnoticeable to the human eye, therefore allowing secret messages to be exchanged discreetly under the form of banal images.
